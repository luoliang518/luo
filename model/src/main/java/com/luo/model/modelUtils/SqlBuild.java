...
public class SqlBuild {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SqlBuild.class);
...
//        String prefix = "com.test.model.entity.";
    ...
    public static String generateSql(String className, String tablePrefix) {
        try {
            ...
            int i1 = column.indexOf("`", 0);
            int i = column.indexOf("`", column.indexOf("`") + 1);
            String id = column.substring(i1, i + 1);
