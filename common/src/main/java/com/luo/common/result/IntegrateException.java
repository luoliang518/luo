...
public class IntegrateException extends RuntimeException implements BaseEnum {
    ...
    public static <T extends BaseEnum> void buildExternalEx(T enumName) {
        throw new IntegrateException(enumName.getStatus(), enumName.getValue());
    }

    public static <T extends BaseEnum> void buildExternalEx(T enumName, String... params) {
        throw new IntegrateException(enumName.getStatus(), enumName.getValue(), null, params);
    }

    public static <T extends BaseEnum> void buildExternalEx(Throwable cause, T enumName, String... params) {
